...
#ifdef USE_SIMU 
p[SIMU_START_LAT] = DEFAULT_SIMU_START_LAT; 
p[SIMU_START_LON] = DEFAULT_SIMU_START_LON; 
p[SIMU_NACT] = DEFAULT_SIMU_NACT; 
p[SIMU_MASS] = DEFAULT_SIMU_MASS; 
p[SIMU_MOT_TAU] = DEFAULT_SIMU_MOT_TAU; 
p[SIMU_DRAG_CONSTANT] = DEFAULT_SIMU_DRAG_CONSTANT; 
p[SIMU_ROT_DRAG] = DEFAULT_SIMU_ROT_DRAG; 
#endif  
#ifdef USE_CARTOS
    p[CARTOS_MASS] =  DEFAULT_CARTOS_MASS;
    p[CARTOS_NACT] =  DEFAULT_CARTOS_NACT;
    p[CARTOS_AM1] = DEFAULT_CARTOS_AM1;
    p[CARTOS_AM2] = DEFAULT_CARTOS_AM2;
    p[CARTOS_MAX_TILT] =  DEFAULT_CARTOS_MAXTILT;
    p[CARTOS_PD_FILT] = DEFAULT_CARTOS_PDFILT;
    p[CARTOS_VD_FILT] = DEFAULT_CARTOS_VDFILT;
    p[CARTOS_VT_FILT] = DEFAULT_CARTOS_VTFILT;
    p[CARTOS_ALT_PRI] = DEFAULT_CARTOS_ALTPRI;
    p[CARTOS_ALT_INIT] = DEFAULT_CARTOS_ALT_INIT;
    p[CARTOS_DEC_DIST] = DEFAULT_CARTOS_DEC_DIST;
    p[CARTOS_HOLD_DIST] = DEFAULT_CARTOS_HOLD;
    p[CARTOS_THRO_SENS] = DEFAULT_CARTOS_THRO_SENS;
    p[CARTOS_THRO_RATE] = DEFAULT_CARTOS_THRO_RATE;
    p[CARTOS_NUM_0] =  DEFAULT_CARTOS_NUM0;
    p[CARTOS_NUM_1] =  DEFAULT_CARTOS_NUM1;
    p[CARTOS_DEN_1] =  DEFAULT_CARTOS_DEN1;
    p[CARTOS_DEN_2] =  DEFAULT_CARTOS_DEN2;
#endif
